...
<p align="center"><em>Figure: Depthwise 2D Convolution Architecture — Legolas packs P=4 channels contiguously so a single SIMD FMA instruction computes 4 channel convolutions simultaneously in 1 clock cycle.</em></p>
